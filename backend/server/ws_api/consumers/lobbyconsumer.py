...
# Endpoints and commands (Client -> Server)
    ...
    CREATE_3v3 = 'create_3v3'                           # Command to create a 3v3 match arguments: pass the values as of 'client_id' eg: {'command': 'create_3v3', 'data': {'opponent_id': '1'}}
# ---------------------------------------
    ...
    async def receive(self, text_data):
        try:
            ...
            if command == self.LIST_OF_USERS:
                ...
                await self.create_3v3(self.client_id, data['opponent_id'])
            else:
...
# Database methods synchronised with the channel layer
    ...
    @database_sync_to_async
    def create_3v3(self, user_id, opponent_id):
        try:

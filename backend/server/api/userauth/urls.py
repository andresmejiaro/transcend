...
from .views.user import info_me_view, info_me_id_view, update_avatar_view, get_user_id, user_exists
...
from .views.user_game import user_all_matches, user_all_tournaments, user_stats
